...
def is_blackjack(card_one, card_two):
    ...
    if card_one in face_cards and card_two is 'A' or card_two in face_cards and card_one is 'A':
        return True
    
    elif card_one is 'A' and card_two is '10' or card_two is 'A' and card_one is '10':
        return True
